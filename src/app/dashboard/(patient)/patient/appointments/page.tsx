...
import {
  ...
  ChevronRight, Stethoscope, Activity, ArrowUpRight, CalendarClock, ExternalLink
} from "lucide-react";
...
export default function PatientAppointmentsPage() {
  ...
  return (
    <div className="max-w-lg mx-auto pb-8 -mx-1">
      ...
      {/* 🔔 Consultation Actions Panel */}
      <div className="mx-1 mb-4">
        <h2 className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Pending Actions</h2>
        <ConsultationActions />
      </div>
              ...
              {apt.status === 'in-consultation' && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2 bg-violet-600 text-white rounded-lg text-[11px] font-semibold flex items-center justify-center gap-1.5 hover:bg-violet-700 active:scale-[0.98] transition"
                  >
                    <Video className="w-3.5 h-3.5" /> Open Chat
                  </button>
                </div>
              )}
